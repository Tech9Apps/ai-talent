          ...
          {!user && (
            <Box sx={{ mb: 6 }}>
              ...
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, sm: 6 }}>
                  <Card sx={{ p: 3, cursor: 'pointer', '&:hover': { boxShadow: 2 } }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Experience AI-powered talent matching with sample data and explore the interface
                    </Typography>
                  </Card>
                </Grid>
                <Grid size={{ xs: 12, sm: 6 }}>
                  <Card sx={{ p: 3, cursor: 'pointer', '&:hover': { boxShadow: 2 } }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Test our CV analysis features with pre-loaded sample resumes
                    </Typography>
                  </Card>
                </Grid>
              </Grid>
          ...
          <Box sx={{ position: 'sticky', top: 24 }}>
            ...
            <Card sx={{ p: 0 }}>
              <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, p: 2, '&:hover': { bgcolor: 'action.hover' } }}>
                  <Box 
                    sx={{ 
                      width: 32, 
                      height: 32, 
                  ...
                  <Chip 
                    ...
                    size="small" 
                    variant="outlined"
                    sx={{ minWidth: 'auto', width: 24, height: 24, '& .MuiChip-icon': { margin: 0 } }}
                  />
                </Box>
              ...
              {/* Pagination */}
              <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', p: 2, borderTop: '1px solid', borderColor: 'divider' }}>
                <Typography variant="caption" color="text.secondary">
                  1-4 de 4
                </Typography>
              </Box>
